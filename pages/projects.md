...
projects:
  ...
  Hobby:
    - name: 'Freebio'
      ...
      icon: 'i-ri-code-box-line'
    - name: 'Hobits'
      link: 'https://github.com/syofyanzuhad/hobits'
      desc: 'A Progressive Web App open source for tracking daily habits with offline support, built with Vue 3 and TypeScript.'
      icon: 'i-ri-code-box-line'
    - name: 'Libur Hari Ini'
